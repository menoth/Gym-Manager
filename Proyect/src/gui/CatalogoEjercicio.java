...
//----------------------"CATÁLOGO"-----------------------------------------------------------------
	...
	//-----------------------------------MÉTODOS-------------------------------------------------------------------------------------------
		...
		//Método para el panel de elegir cuantar repeticiones... hacer de cada ejercicio
	/**
		protected void elegirInfoEjercicios() {
			
			// Crear el diálogo
		    JDialog dialog = new JDialog(this, "Información del Ejercicio", true);
		    dialog.setLayout(new BorderLayout());
		    dialog.setSize(300, 200);
		...
		**/
		protected void meterEjercicioEnTabla() {
